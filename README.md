...
로컬 문제 JSON 검증·가져오기: [Import 사용 안내](IMPORT.md).

---

## 🗺️ 개발 로드맵

[GitHub Issues](https://github.com/parkharoi/jungsil/issues)에서 개발 작업을 관리할 예정입니다.
기존 체크리스트는 [이슈 이전용 로드맵](ROADMAP.md)에 보관했습니다.
